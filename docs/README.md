...
3. **[ROADMAP-SUMMARY.md](roadmap/ROADMAP-SUMMARY.md)** — Quick reference: 22 features, 3 milestones, 8 weeks
...
| **[ROADMAP.md](roadmap/ROADMAP.md)** | Detailed 22-feature roadmap with APIs, complexity, dependencies | Everyone | 20 min |
| **[ROADMAP-SUMMARY.md](roadmap/ROADMAP-SUMMARY.md)** | Quick reference: timeline, features, decisions, metrics | Everyone | 5 min |
...
| **[FEATURE-DEPENDENCIES.md](roadmap/FEATURE-DEPENDENCIES.md)** | Build order, parallelization, critical path, testing strategy | Tech Lead, Eng Manager | 10 min |
...
2. Skim **[ROADMAP.md](roadmap/ROADMAP.md)** (feature descriptions, business impact)
3. Reference **[ROADMAP-SUMMARY.md](roadmap/ROADMAP-SUMMARY.md)** (quick facts)

### Engineering Lead / Tech Lead
1. Read **[CLAUDE.md](../CLAUDE.md)** (tech stack, conventions)
2. Read **[FEATURE-DEPENDENCIES.md](roadmap/FEATURE-DEPENDENCIES.md)** (build order, critical path)
3. Skim **[ROADMAP.md](roadmap/ROADMAP.md)** (APIs, component architecture, complexity)

### Developer
1. Read **[GETTING-STARTED-PRODUCT.md](GETTING-STARTED-PRODUCT.md)** (workflow, common questions)
2. Reference **[ROADMAP.md](roadmap/ROADMAP.md)** for your feature (description, APIs, component structure)
...
2. Skim **[ROADMAP-SUMMARY.md](roadmap/ROADMAP-SUMMARY.md)** for context
3. Reference **[ROADMAP.md](roadmap/ROADMAP.md)** for UI descriptions of each feature

### QA / Test Engineer
1. Read **[CLAUDE.md](../CLAUDE.md)** (testing conventions: Jasmine, Playwright)
2. Read **[FEATURE-DEPENDENCIES.md](roadmap/FEATURE-DEPENDENCIES.md)** (testing strategy per feature)
3. Reference **[ROADMAP.md](roadmap/ROADMAP.md)** for acceptance criteria

### Marketing / Growth
1. Read **[PRODUCT-BRIEF.md](PRODUCT-BRIEF.md)** (value prop, competitive positioning, GTM)
2. Skim **[ROADMAP-SUMMARY.md](roadmap/ROADMAP-SUMMARY.md)** (timeline, monetization strategy)
...
A: Check [FEATURE-DEPENDENCIES.md](roadmap/FEATURE-DEPENDENCIES.md) for build order. Some features block others; parallel work is possible.
